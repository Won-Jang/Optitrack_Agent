...
public class OptitrackServerDescription
{
...
public class OptitrackStreamingClient : MonoBehaviour
{
    ...
    public Dictionary<Int32, OptitrackMarkerState> GetMarkerStates()
    {
        return this.m_latestMarkerStates;
    }

    public OptitrackServerDescription GetServerDesc()
    {
...
#region Private methods
    ...
    private void RigidBodyDataToState(sRigidBodyData rbData, OptitrackHiResTimer.Timestamp timestamp, OptitrackRigidBodyState rbState)
    {
        ...
        //Debug.Log("Rotation: " + rbState.Pose.Orientation, this);
    }
