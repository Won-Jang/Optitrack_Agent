...
namespace Agent
{
    public delegate void ServerHandlePacketData(byte[] data, int bytesRead);
    ...
    public class TCPIP : BTSocket
    {
        ...
        private void ListenForClients()
        {
            ...
            while (started)
            {
                ...
                catch { Debug.Log("listener stopped"); }
            }
        }
        ...
        private void WorkWithClient(object client)
        {
            ...
            while (started)
            {
                ...
                catch
                {
                    ...
                    Debug.Log("A socket error has occurred with client: " + tcpClient.ToString());
                    break;
                }
                ...
                if (OnDataReceived != null)
                {
                    ...
                    OnDataReceived(clientBuffers[tcpClient].ReadBuffer, bytesRead);
        ...
        private void DisconnectClient(TcpClient client)
        {
            ...
            Debug.Log("Disconnected client: " + client.ToString());
